...
void detectAndDraw(Mat &img, CascadeClassifier &cascade, double scale, bool tryflip)
{
    ...
    cascade.detectMultiScale(smallImg, faces,
                             1.3, 2, 0 | CASCADE_FIND_BIGGEST_OBJECT,
    ...
    drawTransparency(img, overlay, 0, 0);
    ...
    // putText(img, std::to_string(img.get(cv::CAP_PROP_FPS)), Point(10, 10), FONT_HERSHEY_PLAIN, 1, Scalar(0, 0, 0)); // fonte
}
